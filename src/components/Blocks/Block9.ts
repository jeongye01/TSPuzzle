...
const blockShape=[[1,1,1],[1,1,1],[1,1,1]];
export function Block9 (diffSetter:(x:number,y:number)=>void,blockSetter:(block:HTMLDivElement,fillFunc:(x:number,y:number)=>void,overFunc:(x:number,y:number)=>void)=>void){
